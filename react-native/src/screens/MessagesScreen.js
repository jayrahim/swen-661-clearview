...
const styles = StyleSheet.create({
  ...
  composeText: { fontWeight: '700' },
  content: { padding: 18 },
  date: { fontSize: 14, marginLeft: spacing.md },
  headerRow: {
    alignItems: 'center',
    flexDirection: 'row',
  ...
  preview: { fontSize: 16, marginTop: spacing.sm },
  pressed: { opacity: 0.7 },
  sender: { flex: 1, fontSize: 16, fontWeight: '700' },
  subject: { fontSize: 16, fontWeight: '700', marginTop: spacing.sm },
  title: { fontSize: 24, fontWeight: '700' },
  unread: { fontSize: 14, fontWeight: '700', marginTop: spacing.sm },
});
